...
// PasBox.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPasBoxApp, CWinApp)
...
// Единственный объект CPasBoxApp

CPasBoxApp theApp;


// инициализация CPasBoxApp

BOOL CPasBoxApp::InitInstance()
{
